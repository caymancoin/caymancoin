...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 CYM
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 CYM mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 747520000 * COIN;  //10 year distribution
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        return dPriority > COIN * 1600 / 250;
    }

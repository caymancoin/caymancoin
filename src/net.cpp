...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Caymancoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"digitalcurrencytools.com", "dnsseed.digitalcurrencytools.com"},
    {"megahash.org", "dnsseed.megahash.org"},
    {"cympools.com", "74.208.14.93"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Caymancoin is probably already running."), addrBind.ToString().c_str());
        else
